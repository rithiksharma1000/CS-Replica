...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        //Disabling movement when pause menu is enabled.
        ...
        //Locking the cursor to the game window
        ...
        // Caculate movement velocity as a 3D vetor
        ...
        float _cameraRotationX = _xRot* lookSensitivity*Time.fixedDeltaTime;
